...
Rscript ${SHELL_FOLDER}/RemoveDropOut.R ${out_dir}/${out_name}_DropoutNumber_row ${out_dir}/${out_name}_DropoutNumber_col ${out_dir}/${out_name}_passed_genelist ${out_dir}/${out_name}_passed_col
...
echo "KNN analysis"
Rscript ${SHELL_FOLDER}/KNN.R ${out_dir}/${out_name}_matrix_filter ${out_dir}/${out_name}_matrix_KNN
