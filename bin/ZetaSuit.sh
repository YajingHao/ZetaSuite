...
sh QC.sh -a ${in_dir} -b ${out_dir} -i ${in_file} -o ${out_name} -n ${negative_control} -p ${positive_control}
echo "do event coverage calculation"
sh EventCoverage_combine.sh -a ${in_dir} -b ${out_dir} -i ${in_file} -o ${out_name} -n ${negative_control} -p ${positive_control}
...
sh Zeta.sh -a ${in_dir} -b ${out_dir} -i ${in_file} -o ${out_name} 
#echo "calculate zeta score consider svm curve"
#sh Zeta_SVM.sh -i ${in_file} -o ${out_name}
echo "do FDR analysis"
sh FDR_cutoff_combine.sh -a ${in_dir} -b ${out_dir} -i ${out_name}_Zeta.txt -o ${out_name} -n ${negative_control} -p ${positive_control}
