...
p1<-ggplot(Dec,aes(x=Cut.Off,y=SS,col=Type))+geom_point()+geom_smooth(span=0.2)+xlim(0,0.25)+theme_bw()+xlab("Zeta Score")+ylab("Screen strength")+theme(legend.position = c(0.8, 0.2),legend.title=element_blank())
